...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/joy.git")
			os.system("rm -rf DARLIHOT1/joy.py")
			os.system("cp -f joy.py \\.")
			os.system("rm -rf joy.py")
